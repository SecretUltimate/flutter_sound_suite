  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        ...
        onTap: () => Provider.of<SoundPlayerModel>(context, listen: false)
            .startOrStopPlayer(
        ...
        child: Stack(
          ...
          children: [
            Visibility(
              visible: Provider.of<SoundPlayerModel>(context)
                  .isCurrentPlaying(filePath: widget.filePath),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(4),
                child: LinearProgressIndicator(
                  minHeight: 35,
                  value:
                      Provider.of<SoundPlayerModel>(context).currentPlayTime /
                          widget.duration,
                  valueColor:
            ...
            Row(
              children: [
                ...
                Icon(Provider.of<SoundPlayerModel>(context)
                        .isCurrentPlaying(filePath: widget.filePath)
                    ? Icons.stop
                    : Icons.play_arrow),
                SizedBox(
